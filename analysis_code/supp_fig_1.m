% This code generates Figure S1 in supplementary information for:
...
%% Specify Directory
file_dir = '/.../.../'; % Provide the directory location to 2019_pest_results.mat

%% Load Data
load ([file_dir '2019_pest_results.mat'])
